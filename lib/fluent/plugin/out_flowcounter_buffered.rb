...
class Fluent::FlowCounterOutputBuffered < Fluent::BufferedOutput
  Fluent::Plugin.register_output('flowcounter_buffered', self)
  ...
  def write(chunk)
    ...
    log.warn "FlowCounter exception occurred: #{e}"
